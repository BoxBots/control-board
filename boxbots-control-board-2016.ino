/* Code for 2016 Season Box Bots robot control board
 * 
...
#define   weaponpin 11   // pin that the weapon is on - servo output
#define   weaponlvl 450  // weapon input level to activate "on" 
...
int spd = 0;
byte neutral = 255;
int maxweapon = 100;  // Ch3 Weapon max power out of 180 
